        ...
        <div className="contact" id="contact">
            ...
            <div className='contact-info'>
                <div className='location'>
                    <div className='icons-container'><a rel="noreferrer" href="https://maps.app.goo.gl/65bg6Z4PtM23J3Rr5" target="_blank" ><img className='icons' src="./images/location.png" alt="location" /></a></div>
                ...
                <div className='social'>
                    <div className='social-icons-container'>
                        <a rel="noreferrer" href="https://www.instagram.com/boss_burger_1/?igsh=d3RnMXBqc2p5dGRi#" target="_blank" ><img className='icons' src="./images/instagram.png" alt="instagram" /></a>
            ...
            <div className="dev-container">
                B.S Softwares &copy; 2025 <br /> 
                Mohammad Safieddine +96181076393 <br />
                mohammadsafieddine@gmail.com
            </div>
        </div>
    );
}
